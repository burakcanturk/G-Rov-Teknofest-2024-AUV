...
from rov_control import rovVehicleUart, rovVehicleSwd
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.grovUart = rovVehicleUart(self.port, self.baud)
        #self.grovUart.getAddress(show = True)
        #self.grovSwd = rovVehicleSwd()
        ...
        self.DisFrontLabel.setFont(self.font)
        self.DisBackLabel.setFont(self.font)
        self.DisRightLabel.setFont(self.font)
        self.DisLeftLabel.setFont(self.font)
        self.DisLowerLabel.setFont(self.font)

        self.RollLabel.setFont(self.font)
        self.PitchLabel.setFont(self.font)
        self.YawLabel.setFont(self.font)

        self.VoltageLabel.setFont(self.font)
        self.CurrentLabel.setFont(self.font)
        ...
        self.cam = cv2.VideoCapture(self.CAM_NUM, cv2.CAP_DSHOW)
    ...
    def setRolicamAngle(self, val):
        self.RolicamAngleTxt.setText(str(val))
        ...
        while True:
            ...
            if self.camOn:
                ...
                if ret:
                    ...
                    bytes_per_line = ch * w
                    convert_to_Qt_selfat = QImage(frame_rgb.data, w, h, bytes_per_line, QImage.Format_RGB888)
